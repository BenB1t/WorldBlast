...
extends RefCounted
## Full ISO-3166 alpha-2 country list. The code is stored on the player
## and sent to the server; the name is only for the dropdown UI.
## Each entry: [code, display_name]
...
const LIST: Array = [
	...
	["TL", "Timor-Leste"], ["TG", "Togo"], ["TO", "Tonga"], ["TT", "Trinidad & Tobago"], ["TN", "Tunisia"],
